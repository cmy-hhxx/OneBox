...
struct ListenedInterval: Codable, Equatable, Hashable, Sendable {
...
struct ListeningHistory: Codable, Equatable, Hashable, Sendable {
    private(set) var intervals: [ListenedInterval]

    init(intervals: [ListenedInterval] = []) {
    ...
    func listenedFraction(duration: TimeInterval) -> Double {
    ...
    func isComplete(duration: TimeInterval) -> Bool {
