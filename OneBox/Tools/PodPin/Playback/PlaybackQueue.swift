...
public enum PlaybackQueuePlacement: Sendable {
    case next
    case last
}
...
public struct PlaybackQueueEntry: Identifiable, Equatable, Sendable {
    public let item: AudioItem
    public let position: Int
    public let enqueuedAt: Date

    public var id: UUID { item.id }

    public init(item: AudioItem, position: Int, enqueuedAt: Date) {
        self.item = item
